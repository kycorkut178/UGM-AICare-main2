...
const feedbackQuestions = [
    { id: 'easeOfUse', label: '1. Overall, how easy or difficult was it to use the NEURA-K3 webapp today?', type: 'slider', min: 1, max: 5, step: 1, defaultValue: 3, labels: { 1: 'Very Difficult', 5: 'Very Easy' } },
    { id: 'understanding', label: '2. How well did NEURA-AI understand you during your chat?', type: 'slider', min: 1, max: 5, step: 1, defaultValue: 3, labels: { 1: 'Not at all', 5: 'Very Well' } },
    ...
    { id: 'nps', label: '5. How likely are you to recommend NEURA-K3? (0=Not Likely, 10=Very Likely)', type: 'slider', min: 0, max: 10, step: 1, defaultValue: 5, labels: { 0: 'Not Likely', 10: 'Very Likely'} },
...
const FeedbackForm: React.FC<FeedbackFormProps> = ({ onClose, onSubmitSuccess }) => {
    ...
    return (
        ...
        <div className="p-4 sm:p-6 bg-linear-to-br from-gray-800 via-gray-900 to-black text-white rounded-xl shadow-2xl w-full border border-gray-700 relative overflow-hidden">
            ...
            <p className="text-sm text-gray-400 mb-6 text-center">Your anonymous feedback helps us improve NEURA-K3.</p>
