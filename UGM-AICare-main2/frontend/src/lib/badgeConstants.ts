...
export const badgeMetadataMap: { [key: number]: BadgeMeta } = {
    1: {
        ...
        "description": "Awarded for the first recorded journal entry or chat activity in NEURA-K3. Welcome!",
    ...
    8: {
        "name": "Besties!",
        "description": "Awarded for having a single continuous chat session with NEURA-AI containing over 100 messages.",
