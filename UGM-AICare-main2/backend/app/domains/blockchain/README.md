...
The **blockchain/** module consolidates all smart contract interactions for the NEURA-K3 platform across **multiple blockchains**, providing a clean separation of concerns from business logic.

## 🌐 Multi-Chain Architecture

NEURA-K3 integrates with **two blockchains**:
