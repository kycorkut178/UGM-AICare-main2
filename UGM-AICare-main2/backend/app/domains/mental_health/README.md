...
The **mental_health/** domain consolidates all mental health-related functionality for the NEURA-K3 platform. This is the **core domain** of the application, handling therapeutic services, user wellness, and clinical operations.
