"""
NEURA-AI - The Meta-Agent

NEURA-AI (愛佳) is the unified AI consciousness of NEURA-K3.
...
⚠️ IMPORTANT: Use the cached agent singleton, NOT per-request compilation!
  ...
  neura-ai = get_aika_agent()  # compiled once at startup, reused per request
  result = await neura-ai.ainvoke(state, config={"configurable": {"thread_id": "...", "db": db}})
"""
