"""Static constants used across NEURA-AI agent modules.
...
# ---------------------------------------------------------------------------
# NEURA-AI-name prefix smalltalk variants (Tier-2, max 22 chars)
# ---------------------------------------------------------------------------
SMALLTALK_AIKA_PREFIX: frozenset[str] = frozenset({
    "hi neura-ai", "halo neura-ai", "hai neura-ai", "hello neura-ai", "hey neura-ai",
    "thank you neura-ai", "makasih ya", "terima kasih ya",
    "oke neura-ai", "ok neura-ai", "sip neura-ai", "noted neura-ai", "bye neura-ai",
})
