"""
NEURA-AI's Screening Awareness Module

This module provides NEURA-AI with awareness of:
...
Design Philosophy:
- NEURA-AI should feel like a genuine friend, NOT a clinical interviewer
...
Integration:
- This module is called during NEURA-AI's response generation
- It adds "screening guidance" to NEURA-AI's system prompt
...
def generate_screening_guidance(
    ...
    """Generate screening guidance to add to NEURA-AI's system prompt.
    
    This gives NEURA-AI awareness of what to naturally explore without
...
async def enhance_response_with_probe(
    ...
    """Enhance NEURA-AI's response with a natural screening probe if appropriate.
    
    This is called AFTER NEURA-AI generates her response, to optionally add
    a natural probe at the end.
    
    Args:
        base_response: NEURA-AI's original response
...
async def get_screening_aware_prompt_addition(
    ...
    """Get screening-aware addition to NEURA-AI's system prompt.
    
    Call this before generating NEURA-AI's response to give her awareness
