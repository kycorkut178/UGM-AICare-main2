"""
NEURA-AI State Management

Defines the state structure passed through NEURA-AI's orchestration graph.
"""
...
class AikaState(BaseModel):
    """
    State passed through NEURA-AI's LangGraph orchestration.
...
class AikaResponseMetadata(BaseModel):
    """Metadata about NEURA-AI's response for debugging and analytics"""
