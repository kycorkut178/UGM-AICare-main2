...
class UserPreferences(Base):
    ...
    email_newsletter = Column(
        Boolean,
        default=True,
        comment="Subscribe to NEURA-K3 newsletter"
    )
    ...
    auto_suggest_interventions = Column(
        Boolean,
        default=True,
        comment="NEURA-AI proactively suggests CBT interventions"
    )
    ...
    def __repr__(self):
        return f"<UserPreferences(user_id={self.user_id}, lang='{self.preferred_language}', neura-ai='{self.aika_personality}')>"
